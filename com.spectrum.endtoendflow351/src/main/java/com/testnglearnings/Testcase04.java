...
public class Testcase04 extends InvokeBrowsers{
	@BeforeClass
	public void testcasedata() {
		testcasename="tc04kpntravelsprinttext";
	...
	public void kpntravels(){
		driver.get(url);
		try {
			System.out.println(driver.findElementByXPath("//div[@class='content-about1']/div/div[2]/div/h3").getText());
			status="pass";
		} catch (Exception e) {
