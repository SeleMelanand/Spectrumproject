...
public class InvokeBrowsers {
	...
	public void htmlreportgenerator() {
		html = new ExtentHtmlReporter("./reports/tuesdayresult02.html");
	...
	public void takesnapshot(String testcase) throws IOException {
		...
		if(status.equalsIgnoreCase("pass"))	{
			//test.pass(testcasename + " - testcase passed");
			test.pass("Testcase passed successfully",MediaEntityBuilder.createScreenCaptureFromPath("./../reports/images/"+ testcase +number+".jpg").build());
